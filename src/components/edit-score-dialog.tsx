...
export function EditScoreDialog({
  ...
  const studentTestType = useMemo(
    () => student?.["Test Types"]?.[0],
    [student],
  );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 rounded-md border p-4">
                  {currentTestConfig.sections.map(
                    (section: any, index: number) => {
                      const existingScore = form
                        .watch("scores")
                        ?.find((s) => s.section === section.name);
                              ...
                              <FormControl>
                                <Stepper
                                  ...
                                  onValueChange={(newScore) => {
                                    ...
                                    const otherScores = currentScores.filter(
                                    ...
                                    newScores.sort((a, b) => {
                                      ...
                                      return (
                                        sectionOrder.indexOf(a.section) -
                                        sectionOrder.indexOf(b.section)
                                      );
                                    });
